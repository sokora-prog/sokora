  ...
  return (
    ...
    >
      ...
      <View style={styles.balanceCard}>
        <Text style={styles.balanceLabel}>Solde SOKORA</Text>
      ...
      <View style={styles.qrSection}>
        <Text style={styles.sectionTitle}>Mon QR Code de paiement</Text>
        ...
        <Text style={styles.qrHint}>
          Présentez ce QR code au caissier pour payer
        </Text>
      </View>
